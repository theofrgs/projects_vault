  ...
  return (
    <ProjectDialog project={project}>
      <div className="relative flex-shrink-0 cursor-pointer transform hover:scale-105 transition duration-200 ease-out hover:drop-shadow-lg">
        <div className="absolute z-20 bottom-5 left-5 flex flex-col gap-2 overflow-hidden max-w-36 md:max-w-xs ">
          <h2 className="font-semibold sm:text-base text-[10px]">{project.title}</h2>
            <ProjectTags project={project} variant={TagVariant.S} />
        </div>
        <Image
          className="w-fit lg:min-w-[400px] h-32 md:h-56 object-cover object-center shadow-md shadow-gray-900 drop-shadow-xl rounded-sm"
